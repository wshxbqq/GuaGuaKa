<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="guaguale_ggl_admin_index" %>
...
<body>
        ...
        <div class="hero-unit ht ht1">
            ...
            <form class="form-horizontal">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="projectName" name="projectName" placeholder="活动名称" />
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="jshopUrl">jshop页面地址</label>
                    <div class="controls">
                        <input type="text" id="jshopUrl" name="jshopUrl" placeholder="jshop页面地址" />
                    </div>
                </div>
            ...
            <form class="form-horizontal">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <img class="img_big_bg" src="../ggl/img/bigbg.jpg" />
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <img class="img_mask" src="../ggl/img/mask.jpg" />
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <img class="img_lose" src="../ggl/img/lose.jpg" />
                    </div>
                </div>
                ...
                <div class="prize_content">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="shop_uuid" placeholder="对应风控系统生成的UUID" />
                        </div>
                    </div>
    ...
    <script>
        window.p_uuid = window.Common.uuid();
